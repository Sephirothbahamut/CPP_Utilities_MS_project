...
void directwrite()
	...
	formatted_string.regions.fill         .render_to.image.reset(true);
	formatted_string.regions.outline      .render_to.image.reset(true);
	formatted_string.regions.underline    .render_to.image.reset(true);
	formatted_string.regions.highlight    .render_to.image.reset(true);
	formatted_string.regions.strikethrough.render_to.image.reset(true);

	formatted_string.regions.fill         .enabled.add(false, {6,  3});
	formatted_string.regions.outline      .enabled.add(true , {6, 15});
	formatted_string.regions.underline    .enabled.add(true , {5,  5});
	formatted_string.regions.underline    .enabled.add(true , {6,  5});
	formatted_string.regions.strikethrough.enabled.add(true , {5,  5});
	formatted_string.regions.strikethrough.enabled.add(true , {6,  5});

	formatted_string.regions.fill         .colour.add(utils::graphics::colour::rgba_f{1.f, 0.f, 0.f, 1.f}, {0, 30});
	formatted_string.regions.fill         .colour.add(utils::graphics::colour::rgba_f{0.f, 1.f, 0.f, 1.f}, {3,  3});
	formatted_string.regions.outline      .colour.add(utils::graphics::colour::rgba_f{.3f, 1.f, .7f, 1.f}, {0, 30});
	formatted_string.regions.underline    .colour.add(utils::graphics::colour::rgba_f{1.f, 0.f, 0.f, 1.f}, {0, 11});
	formatted_string.regions.underline    .colour.add(utils::graphics::colour::rgba_f{1.f, 1.f, 0.f, 1.f}, {2,  3});
	formatted_string.regions.strikethrough.colour.add(utils::graphics::colour::rgba_f{1.f, 0.f, 0.f, 1.f}, {0, 11});
	formatted_string.regions.strikethrough.colour.add(utils::graphics::colour::rgba_f{1.f, 1.f, 0.f, 1.f}, {2,  3});
	formatted_string.regions.font.add(u"Arial", {3, 5});
	formatted_string.regions.size.add(48.f, {5, 4});
